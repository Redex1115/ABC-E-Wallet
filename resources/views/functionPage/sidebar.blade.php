    ...
    <div class="scroll-sidebar ps ps--theme_default" data-ps-id="99fc981b-8e50-5321-9274-487b83d68f64">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li><a class="waves-effect waves-dark" href="{{url('admin/table',['id' => Auth::user()->id])}}" aria-expanded="false"><i class="fa fa-table"></i><span class="hide-menu"></span>Member Entry</a></li>
